...
### **💼 Commercial (PAID)**
For businesses and commercial deployments

- **5-10% monthly royalty** (tiered by revenue)
- **Production deployment rights**
- **Monthly reporting + payment**
- **Professional support available**

📖 [Read Commercial License](./COMMERCIAL-LICENSE.md)
📋 [View Agreement Template](./COMMERCIAL-LICENSE-AGREEMENT.md)
...
### I'm a **Student** → Use Community License (FREE)
✅ Build projects for learning
✅ Contribute to open source
✅ No payment, just credit the authors
[👉 Get Started](./COMMUNITY-LICENSE.md)

---

### I'm **Running a Business** → Use Commercial License (PAID)
✅ Deploy for revenue generation
✅ Pay 5-10% monthly royalty
✅ Professional support available
[👉 Get Started](./COMMERCIAL-LICENSE.md)
[👉 Sign Agreement](./COMMERCIAL-LICENSE-AGREEMENT.md)
...
### I'm **Running a Non-Profit** → Use Community License (FREE)
✅ No profit = Community License applies
✅ Provide proof of non-profit status
✅ Full feature access, just maintain attribution
[👉 Get Started](./COMMUNITY-LICENSE.md)
...
### Tiered Royalty Model

| Annual Revenue | Monthly Rate | Example |
|---|---|---|
| ₹0 - ₹50 Lakhs | **5%** | ₹4,00,000 gross = ₹20,000/month |
| ₹50+ Lakhs | **10%** | ₹6,00,000 gross = ₹60,000/month |

**Important:** Revenue starts the month you first generate it. No retroactive payment.

---

## 📋 For Commercial Users: Key Dates & Tasks

| Task | When | Who | Document |
|---|---|---|---|
| **Sign License Agreement** | Before deployment | You | [COMMERCIAL-LICENSE-AGREEMENT.md](./COMMERCIAL-LICENSE-AGREEMENT.md) |
| **Setup Bank Transfer** | After signing | You | [PAYMENT-SCHEDULE.md](./PAYMENT-SCHEDULE.md) |
| **First Revenue Report** | By 15th of month 1 | You | [PAYMENT-SCHEDULE.md](./PAYMENT-SCHEDULE.md) |
| **Ongoing Monthly Payment** | By 15th each month | You | [PAYMENT-SCHEDULE.md](./PAYMENT-SCHEDULE.md) |
| **Annual Audit Review** | Year anniversary | Licensor | [COMMERCIAL-LICENSE.md](./COMMERCIAL-LICENSE.md) |

See **[PAYMENT-SCHEDULE.md](./PAYMENT-SCHEDULE.md)** for detailed payment procedures.
...
1. **Do you earn any money using this software?**
   - YES → Commercial License
   - NO → Next question

2. **Are you a registered business (any type)?**
   - YES → Commercial License
   - NO → Next question

3. **Is this for learning, a pet project, or non-profit?**
...
```
📄 START HERE
├─ 📋 LICENSE (primary license text)
├─ 📚 LICENSING-GUIDE.md (FAQ & decision help)
│
├─ 👨‍🎓 FOR COMMUNITY USERS
...
| Production deployment | ✅ |
| Commercial revenue | ✅ |
| Support | Available (negotiable) |
| Monthly reporting | ✅ |
| Cost | 5-10% monthly royalty |
...
**Let's build India's open e-commerce platform together! 🇮🇳**
